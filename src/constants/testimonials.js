...
export const detailedTestimonials = [
    {
        ...
        benefits: [
            "Valora haber reducido sus visitas recurrentes al fisioterapeuta.",
            "Percibe cambios positivos en sus hábitos posturales.",
            "Destaca la continuidad y la adaptación de las clases."
        ]
    },
    {
        name: "Macarena",
        ...
        benefits: [
            "Percibe una mejora personal en sus molestias articulares.",
            "Valora los cambios que nota en su cuerpo.",
            "Destaca la corrección constante y el aprendizaje técnico.",
            "Su hija también se siente cómoda en las clases."
        ]
    },
    {
        name: "Esperanza",
        ...
        benefits: [
            ...
            "Continuidad de la práctica a largo plazo.",
